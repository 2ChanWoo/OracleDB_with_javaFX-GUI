// 참조 :: https://www.swtestacademy.com/database-operations-javafx/
...
public class Main extends Application {
    ...
    //여기에서는 FXML의 경로를 폴더처럼 '/' 슬래쉬로 구분을 해 주어야 하네?
    ...
    public void showEmployeeOperationsView() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("view/WorkWindow.fxml"));
